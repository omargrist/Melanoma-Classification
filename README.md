...
|----------------------------|---------------------------------------------------------------|-----------------------------------------------------|---------|-----------------|
| train_b0-hybrid_E80_edwin  | Hybrid EfficientNet-B0 + Transformer (Image only)             | Best Kaggle hybrid from Edwin                       | 0.8746  | 0.8834          |
| train_b7_omar              | EfficientNet-B7 (Metadata + Image)                            | Based on Louis' CW-5 notebook with numerous changes | 0.9210  | 0.8818          |
| create_mean_blend_ensemble | Mean probability blend of the above models (Metadata + Image) | Our best setup so far, 49/7 TP/FN                   | 0.9766* | 0.8992          |
